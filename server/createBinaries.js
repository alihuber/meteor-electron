/* global Meteor, Npm */
import { UPDATE_FEED_PATH, canServeUpdates } from './serveUpdateFeed';
  ...
  builds.forEach(function (buildInfo) {
    ...
    if (electronSettings.autoPackage && electronSettings.bundleClient) {
      ...
      meteorBuildClient({
        ...
        url: electronSettings.rootUrl || 'default',
      });
      buildRequired = true;
    } else {
    ...
    if (buildRequired) {
      ...
      // all options:
      //  dir: '/.meteor-electron/darwin-x64/apps',
      //  name: 'my-app-name',
      //  platform: 'darwin',
      //  arch: 'x64',
      //  version: '4.1.0',
      //  out: '/.meteor-electron/darwin-x64/builds',
      //  download:
      //   { cache: '.meteor-electron/darwin-x64/releases' },
      //  overwrite: true,
      //  'osx-sign': {},
